...
' Script para abrir a transação ME23N no SAP GUI
' Uso: cscript //nologo me23n_exibir_pedido.vbs "4500012345"
...
If Err.Number <> 0 Then
    WScript.Echo "Transação ME23N aberta. Insira o pedido manualmente: " & orderNumber
Else
    WScript.Echo "Pedido " & orderNumber & " aberto para visualização"
End If
